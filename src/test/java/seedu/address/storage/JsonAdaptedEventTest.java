...
public class JsonAdaptedEventTest {
    private static final String INVALID_TITLE = "Meeting with R@chel";
    private static final String INVALID_CLIENT_NAME = "R@chel";
    private static final String INVALID_TIME = "24 March";
    private static final String INVALID_DESCRIPTION = " ";

    private static final String VALID_TITLE = MEETING_WITH_ALICE.getTitleString();
    ...
    public void toModelType_invalidTitle_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(INVALID_TITLE, VALID_TIME,
    ...
    public void toModelType_invalidTime_throwsIllegalValueException() {
        //        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_TITLE, INVALID_TIME,
        //                VALID_CLIENT_NAME, VALID_DESCRIPTION);
    ...
    public void toModelType_nullTime_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_TITLE, null,
                VALID_CLIENT_NAME, VALID_DESCRIPTION);
    ...
    public void toModelType_invalidClientName_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_TITLE, VALID_TIME,
